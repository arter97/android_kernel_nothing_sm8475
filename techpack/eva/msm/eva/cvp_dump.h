...
*/
int eva_md_eva_static_dump_register(const char *name, u64 virt, u64 phys, u64 size);

/*
 * wrapper for static minidump unregister
*/
void eva_md_eva_static_dump_unregister(void);
...
*/
void eva_add_va_node_to_list(enum cvp_dump_type type, void *buff_va,
...
#else
static inline int eva_md_eva_static_dump_register(const char *name, u64 virt, u64 phys, u64 size)
{
	return 0;
}

static inline void eva_md_eva_static_dump_unregister(void)
{
}

static inline void eva_add_va_node_to_list(enum cvp_dump_type type, void *buff_va,
                        u32 buff_size, const char *region_name, bool copy)
{
}

static inline void eva_cvp_va_md_register(char *name, void* notf_blk_ptr)
{
}

static inline void eva_cvp_register_va_md_region(void)
{
}

static inline void eva_cvp_free_va_md_list(void)
{
}

static inline void eva_add_hfi_queue_to_va_md_list(void *device)
{
}

static inline void eva_add_queue_header_to_va_md_list(void *device)
{
}
